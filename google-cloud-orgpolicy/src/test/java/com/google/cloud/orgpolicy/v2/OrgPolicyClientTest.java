...
public class OrgPolicyClientTest {
  ...
  public void listConstraintsTest() throws Exception {
    ...
    assertEquals(expectedResponse.getConstraintsList().get(0), resources.get(0));
  ...
  public void listPoliciesTest() throws Exception {
    ...
    assertEquals(1, resources.size());
    assertEquals(expectedResponse.getPoliciesList().get(0), resources.get(0));
  ...
  public void createPolicyTest() throws Exception {
    ...
    assertEquals(parent.toString(), actualRequest.getParent());
    assertEquals(policy, actualRequest.getPolicy());
    assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
